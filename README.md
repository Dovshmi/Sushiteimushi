...
### גרסה 5
- הוספת תמונות אמיתיות לפריטי תפריט 1–39
- הוספת תמונה ראשית חדשה ל-Hero
- התמונות הסופיות נערכו ידנית על ידי המשתמש ונמצאות ב-`public/images/menu/` וגם ב-`dist/images/menu/`
- חשוב: לא להחליף/לייצר מחדש את תמונות ה-WebP הקיימות בלי בקשה מפורשת מהמשתמש; הן הגרסה המאושרת שמשתלבת טוב עם הרקע

### גרסה 6
- התפריט עודכן לפי `C:\Users\dovsh\Downloads\menu-7b.pdf` כמקור האמת החדש
- פריטים שלא מופיעים ב-PDF החדש נמחקו מהאתר
- תמונות נשמרו רק לפריטים שההתאמה שלהם לפריט החדש ברורה; לשתייה/מגש/מנת ילדים נשאר placeholder emoji
- מספר הטלפון עודכן לפי ה-PDF החדש: `053-231-2540`
...
### כאשר צריך להוסיף או לשנות תמונות

- התמונות הסופיות שאושרו נמצאות ב-`public/images/menu/` כ-WebP.
- שמות הקבצים: `1.webp` עד `39.webp` עבור פריטי התפריט, ו-`main.webp` עבור ה-Hero.
- `src/data/menu.ts` מפנה אליהן דרך `menuImagePath(number)`.
- **לא לדרוס או לייצר מחדש את התמונות הקיימות** בלי בקשה מפורשת מהמשתמש, כי המשתמש תיקן אותן ידנית כך שישתלבו נכון עם הרקע.
- אם מוסיפים תמונה חדשה, לשים אותה תחת `public/images/menu/` ולעדכן את `src/data/menu.ts`.
...
- ✅ Git על GitHub
- ✅ מחובר ל-Vercel
- ✅ תמונות אמיתיות לפריטי 1–39 ול-Hero קיימות ב-`public/images/menu/`
...
- `public/images/menu/*.webp` - התמונות הסופיות תוקנו ידנית על ידי המשתמש; לא לדרוס בלי הוראה מפורשת
